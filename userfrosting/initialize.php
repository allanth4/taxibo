...
$table_booking = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "booking", [
    "created_at",
    "updated_at",
    "user_id",
    "alphaId",
...
$table_geolock = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "geolock", [
    "created_at",
    "updated_at",
    "user_id",
...
$table_pricing = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "pricing", [
    "created_at",
    "updated_at",
    "user_id",
    "json"
...
$table_car = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "car", [
    "created_at",
    "updated_at",
    "user_id",
...
$setting_values = [
    'userfrosting' => [
        'site_title' => 'Taxibo',
        'admin_email' => 'allanth4@gmail.com',
        'email_login' => '1',
        'can_register' => '0',
        'enable_captcha' => '1',
        ...
        'site_location' => 'Scandinavia - Denmark/Sweden/Norge'
    ]
];
